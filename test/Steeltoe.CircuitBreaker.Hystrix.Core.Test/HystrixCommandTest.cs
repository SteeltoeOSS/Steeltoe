...
namespace Steeltoe.CircuitBreaker.Hystrix.Test
{
    public class HystrixCommandTest : CommonHystrixCommandTests<TestHystrixCommand<int>>, IDisposable
    {
        ...
        public void TestDisabledTimeoutWorks()
        {
            ...
            output.WriteLine("CMD : " + cmd.currentRequestLog.GetExecutedCommandsAsString());
            Assert.True(cmd.executionResult.ExecutionLatency >= 900);
        ...
        class TestExecutionTimeoutValueHystrixCommand : HystrixCommand<string>
        {
            ...
            {
                Time.WaitUntil(() => { return token.IsCancellationRequested; }, 3000);
        ...
        public void TestOnRunStartHookThrowsSemaphoreIsolated()
        {
            ...
            Assert.Equal(0, semaphoreCmd.metrics.CurrentConcurrentExecutionCount);
        ...
        public void TestOnRunStartHookThrowsThreadIsolated()
        {
            ...
            Assert.False(executionAttempted.Value);
            Assert.Equal(0, threadCmd.metrics.CurrentConcurrentExecutionCount);
...

        {
            ...
            try
            {
                ...
                Assert.Equal(0, original.metrics.CurrentConcurrentExecutionCount);
                ...
                Assert.Equal(0, fromCache.metrics.CurrentConcurrentExecutionCount);
        ...
        public void TestRequestThenTwoCacheHitsOriginalAndOneCacheHitUnsubscribed()
        {
            ...
            try
            {
                ...
                Assert.Equal(0, fromCache1.metrics.CurrentConcurrentExecutionCount);
                ...
                Assert.Equal(0, fromCache2.metrics.CurrentConcurrentExecutionCount);
        ...
        protected void AddLatency(int latency)
        {
            if (latency > 0)
            {
                try
                {
                    ...
                    Time.WaitUntil(() => { return token.IsCancellationRequested; }, latency);
                    token.ThrowIfCancellationRequested();
    ...
    class TestCommandRejection : TestHystrixCommand<bool>
    {
        ...
        protected override bool Run()
        {
            ...
            try
            {
                Time.WaitUntil(() => { return token.IsCancellationRequested; }, sleepTime);
                token.ThrowIfCancellationRequested();
    ...
    class NoRequestCacheTimeoutWithoutFallback : TestHystrixCommand<bool>
    {
        ...
        protected override bool Run()
        {
            try
            {
                Time.WaitUntil(() => { return token.IsCancellationRequested; }, 500);
                token.ThrowIfCancellationRequested();
    ...
    class InterruptibleCommand : TestHystrixCommand<bool>
    {
        ...
        protected override bool Run()
        {
            try
            {
                Time.WaitUntil(() => { return token.IsCancellationRequested; }, 2000);
                token.ThrowIfCancellationRequested();
    ...
    class EventCommand : HystrixCommand<string>
    {
        ...
        protected override string RunFallback()
        {
            try
            {
                ...
                Time.WaitUntil(() => { return token.IsCancellationRequested; }, 30000);
                token.ThrowIfCancellationRequested();
    ...
    :
        ...
        protected override int RunFallback()
        {
            try
            {
                Time.WaitUntil(() => { return token.IsCancellationRequested; }, 1500);
                token.ThrowIfCancellationRequested();
    ...
    class TestEarlyUnsubscribeDuringExecutionViaToObservableAsyncCommand : HystrixCommand<bool>
    {
        ...
        protected override bool Run()
        {
            try
            {
                Time.WaitUntil(() => { return this.token.IsCancellationRequested; }, 500);
                token.ThrowIfCancellationRequested();
                return true;
            }
            catch (Exception )
