    ...
    public class HystrixRollingNumberTest
    {
        ...
        public void TestShortCircuited()
        {
            ...
            try
            {
                ...
                // the count should be 1
                Assert.Equal(1, counter.buckets.Last.GetAdder(HystrixRollingNumberEvent.SHORT_CIRCUITED).Sum());
        ...
        public void TestUpdateMax1()
        {
            ...
            try
            {
                ...
                Assert.Equal(10, counter.buckets.Last.GetMaxUpdater(HystrixRollingNumberEvent.THREAD_MAX_ACTIVE).Max);
                ...
                // the max
                Assert.Equal(20, counter.buckets.Last.GetMaxUpdater(HystrixRollingNumberEvent.THREAD_MAX_ACTIVE).Max);
        ...
        public void TestUpdateMax2()
        {
            ...
            try
            {
                ...
                Assert.Equal(30, counter.buckets.Last.GetMaxUpdater(HystrixRollingNumberEvent.THREAD_MAX_ACTIVE).Max);
                ...
                // the count
                Assert.Equal(50, counter.buckets.Last.GetMaxUpdater(HystrixRollingNumberEvent.THREAD_MAX_ACTIVE).Max);
