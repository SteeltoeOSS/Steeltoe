...
namespace Steeltoe.CircuitBreaker.Hystrix.Metric.Consumer.Test
{
    public class RollingCommandEventCounterStreamTest : CommandStreamTest, IDisposable
    {
        ...
        static IHystrixCommandGroupKey groupKey = HystrixCommandGroupKeyDefault.AsKey("RollingCommandCounter");
        ...
        public RollingCommandEventCounterStreamTest(ITestOutputHelper output) : base()
        {
