...
{
    public class DiscoverySecurityMiddlewareTest : BaseTest
    {
        ...
        public DiscoverySecurityMiddlewareTest()
        {
            Environment.SetEnvironmentVariable("VCAP_APPLICATION", "somestuff");
        }

        //[Fact]
        //public async void DiscoverySecurityMiddleware_ReturnsServiceUnavailable()
        //{
