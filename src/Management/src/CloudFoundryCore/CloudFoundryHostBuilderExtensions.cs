...
public static class CloudFoundryHostBuilderExtensions
{
    ...
    /// Spring Boot media type version to use with responses.
    /// </param>
    /// <param name="buildCorsPolicy">
    /// Customize the CORS policy.
    /// </param>
    [Obsolete("Cloud Foundry is now automatically supported, use AddAllActuators() instead")]
    public static IWebHostBuilder AddCloudFoundryActuators(this IWebHostBuilder webHostBuilder, MediaTypeVersion mediaTypeVersion,
        Action<CorsPolicyBuilder> buildCorsPolicy = null)
    {
        return webHostBuilder.ConfigureLogging((_, configureLogging) => configureLogging.AddDynamicConsole()).ConfigureServices((context, collection) =>
            ConfigureServices(collection, context.Configuration, mediaTypeVersion, buildCorsPolicy));
    }
    ...
    /// </param>
    [Obsolete("Cloud Foundry is now automatically supported, use AddAllActuators() instead")]
    public static IHostBuilder AddCloudFoundryActuators(this IHostBuilder hostBuilder, MediaTypeVersion mediaTypeVersion,
        Action<CorsPolicyBuilder> buildCorsPolicy = null)
    {
    ...
    [Obsolete("Cloud Foundry is now automatically supported, use AddAllActuators() instead")]
    private static void ConfigureServices(IServiceCollection collection, IConfiguration configuration, MediaTypeVersion mediaTypeVersion,
