...
namespace Steeltoe.Management.OpenTelemetry.Metrics
{
    ...
    internal class DoubleBoundCounterMetricSdk : BoundCounterMetricSdkBase<double>
    {
        ...
        public override void Add(in SpanContext context, double value) => _sumAggregator.Update(value);

        public override Aggregator<double> GetAggregator() => _sumAggregator;
    }
}
