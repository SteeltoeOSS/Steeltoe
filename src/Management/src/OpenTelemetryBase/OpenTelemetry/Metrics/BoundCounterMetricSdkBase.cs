...
namespace OpenTelemetry.Metrics
{
    ...
    internal abstract class BoundCounterMetricSdkBase<T> : BoundCounterMetric<T>
        where T : struct
    {
        internal RecordStatus Status;

        internal BoundCounterMetricSdkBase(RecordStatus recordStatus) => Status = recordStatus;
