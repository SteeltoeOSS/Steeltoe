...
namespace Steeltoe.Management.OpenTelemetry.Metrics
{
    ...
    {
        private readonly Int64LastValueAggregator _aggregator = new ();

        public override void Observe(long value) => _aggregator.Update(value);

        internal Int64LastValueAggregator GetAggregator() => _aggregator;
    }
}
