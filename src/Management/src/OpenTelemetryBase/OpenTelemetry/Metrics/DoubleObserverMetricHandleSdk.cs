...
namespace Steeltoe.Management.OpenTelemetry.Metrics
{
    ...
    {
        private readonly DoubleLastValueAggregator _aggregator = new ();

        public override void Observe(double value) => _aggregator.Update(value);

        internal DoubleLastValueAggregator GetAggregator() => _aggregator;
    }
}
