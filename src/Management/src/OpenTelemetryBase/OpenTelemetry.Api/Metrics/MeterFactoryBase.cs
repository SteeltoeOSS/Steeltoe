...
namespace Steeltoe.Management.OpenTelemetry.Metrics
{
    ...
    {
        private static readonly NoOpMeter _noOpMeter = new ();

        /// <summary>
        /// Gets the dafult instance of a <see cref="MeterFactoryBase"/>.
        /// </summary>
        public static MeterFactoryBase Default { get; } = new ();
        ...
        public virtual Meter GetMeter(string name, string version = null) => _noOpMeter;
    }
}
