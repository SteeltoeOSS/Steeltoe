...
{
    public class ThreadDumpEndpointHandler : EndpointHandler<ThreadDumpResult>
    {
        private readonly RequestDelegate _next;

        public ThreadDumpEndpointHandler(RequestDelegate next, ThreadDumpEndpoint_v2 endpoint, IManagementOptions mgmtOptions, ILogger<ThreadDumpEndpointHandler> logger = null)
