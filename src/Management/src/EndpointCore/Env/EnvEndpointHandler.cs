...
{
    public class EnvEndpointHandler: EndpointHandler<EnvironmentDescriptor>
    {
        private readonly RequestDelegate _next;

        public EnvEndpointHandler(RequestDelegate next, EnvEndpoint endpoint, IManagementOptions mgmtOptions, ILogger<EnvEndpointMiddleware> logger = null)
