...
{
    public class InfoEndpointHandler : EndpointHandler<Dictionary<string, object>>
    {
        private readonly RequestDelegate _next;

        public InfoEndpointHandler(RequestDelegate next, InfoEndpoint endpoint, IManagementOptions mgmtOptions, ILogger<InfoEndpointMiddleware> logger = null)
