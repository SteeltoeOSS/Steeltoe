...
namespace OpenCensus.Tags.Test
{
    ...
    public class TagContextTest
    {
        ...
        {
            var tags = new TagContext(new Dictionary<ITagKey, ITagValue>());
        ...
        {
            var tags = new TagContext(new Dictionary<ITagKey, ITagValue>() { { K1, V1 }, { K2, V2 } });
        ...
        {
            var tags = new TagContext(new Dictionary<ITagKey, ITagValue>() { { K1, V1 } });
