...
public sealed class UnresolvableGitFileWarnsByDefaultTest : GitPropertiesBuildTestBase
{
    [Fact]
    public async Task Test()
    {
        ...
        defaultOutput.Should().ContainOnlyGitWarning(GitDiagnostic.UnresolvableGitFile);
        ...
        disableWarningsOutput.Should().ContainOnlyGitMessage(GitDiagnostic.UnresolvableGitFile);
        testApp.GitPropertiesGenerated.Should().BeFalse();
