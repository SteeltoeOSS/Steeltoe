...
public sealed class RazorPagesExternalAppTest(WebApplicationFactory<Program> factory) : IClassFixture<WebApplicationFactory<Program>>
{
                        ...
                        },
                        {
                          ...
                          "details": {
                            "handlerMethod": {
                              "className": "Steeltoe.Management.Endpoint.RazorPagesWebApp.Test.Pages.TestCasesModel",
                              "name": "OnPatchAsync",
                              "descriptor": "Microsoft.AspNetCore.Mvc.IActionResult OnPatchAsync(System.Guid, System.String, System.Nullable`1[System.Text.Json.JsonElement])"
                            },
                            "requestMappingConditions": {
                              "patterns": [
                                "custom-route/{languageId:int?}"
                        ...
                        },
                        {
                          ...
                          "details": {
                            "handlerMethod": {
                              ...
                              "descriptor": "Void OnDeleteAllAsync()"
                            },
                            "requestMappingConditions": {
                              "patterns": [
                                "custom-route/{languageId:int?}"
