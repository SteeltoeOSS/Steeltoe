...
using Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers;
...
public sealed class MvcControllerTest
{
                ...
                "application": {
                  "mappings": {
                    "dispatcherServlets": {
                      "dispatcherServlet": [
                        {
                          "handler": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.SimpleTestController.Index (Steeltoe.Management.Endpoint.Test)",
                          "predicate": "{GET [{controller=SimpleTest}/{action=Index}/{id?}]}",
                          "details": {
                            "handlerMethod": {
                              "className": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.SimpleTestController",
                              "name": "Index",
                        ...
                        {
                          "handler": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.SimpleTestController.PostAsync (Steeltoe.Management.Endpoint.Test)",
                ...
                "application": {
                  "mappings": {
                    "dispatcherServlets": {
                      "dispatcherServlet": [
                        {
                          "handler": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.AnnotatedTestController.GetAllAsync (Steeltoe.Management.Endpoint.Test)",
                          "predicate": "{GET [annotated-test/get-all], produces [application/xhtml+xml || text/html]}",
                          "details": {
                            "handlerMethod": {
                              "className": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.AnnotatedTestController",
                              "name": "GetAllAsync",
                        ...
                        {
                          "handler": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.AnnotatedTestController.UpdateAsync (Steeltoe.Management.Endpoint.Test)",
                        ...
                        {
                          "handler": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.AnnotatedTestController.Delete (Steeltoe.Management.Endpoint.Test)",
                ...
                "application": {
                  "mappings": {
                    "dispatcherServlets": {
                      "dispatcherServlet": [
                        {
                          "handler": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.MultipleVerbsTestController.GetAll (Steeltoe.Management.Endpoint.Test)",
                          "predicate": "{[GET, HEAD] [{controller=Home}/{action=Index}/{id?}]}",
                          "details": {
                            "handlerMethod": {
                              "className": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.MultipleVerbsTestController",
                              "name": "GetAll",
                        ...
                        {
                          "handler": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.MultipleVerbsTestController.GetById (Steeltoe.Management.Endpoint.Test)",
                ...
                "application": {
                  "mappings": {
                    "dispatcherServlets": {
                      "dispatcherServlet": [
                        {
                          "handler": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.AnyVerbTestController.RespondAtAnyVerb (Steeltoe.Management.Endpoint.Test)",
                          "predicate": "{[GET, HEAD, POST, PUT, DELETE, OPTIONS, PATCH] [{controller=Home}/{action=Index}/{id?}]}",
                          "details": {
                            "handlerMethod": {
                              "className": "Steeltoe.Management.Endpoint.Test.Actuators.RouteMappingsNew.AppTypes.TestMvcControllers.AnyVerbTestController",
    ...
    public async Task Can_get_routes_using_WebHostBuilder()
    {
        ...
        builder.Configure(applicationBuilder =>
            applicationBuilder.UseEndpoints(routes => routes.MapControllerRoute("default", "{controller=Home}/{action=Index}/{id?}")));
    ...
    public async Task Can_get_routes_using_HostBuilder()
    {
        ...
        builder.ConfigureWebHost(webHostBuilder => webHostBuilder.Configure(applicationBuilder =>
            applicationBuilder.UseEndpoints(routes => routes.MapControllerRoute("default", "{controller=Home}/{action=Index}/{id?}"))));
