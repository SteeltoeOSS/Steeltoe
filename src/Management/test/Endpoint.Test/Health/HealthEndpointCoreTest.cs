...
public class HealthEndpointCoreTest : BaseTest
{
    ...
    public void Constructor_ThrowsOnNulls()
    {
        ...
        var optionsEx = Assert.Throws<ArgumentNullException>(() => new HealthEndpointCore(null, _aggregator, contributors, ServiceOptions(), _provider, NullLogger<HealthEndpointCore>.Instance));
        var aggregatorEx = Assert.Throws<ArgumentNullException>(() => new HealthEndpointCore(_options, null, contributors, ServiceOptions(), _provider, NullLogger<HealthEndpointCore>.Instance));
        var contribEx = Assert.Throws<ArgumentNullException>(() => new HealthEndpointCore(_options, _aggregator, null, ServiceOptions(), _provider, NullLogger<HealthEndpointCore>.Instance));
        var svcOptsEx = Assert.Throws<ArgumentNullException>(() => new HealthEndpointCore(_options, _aggregator, contributors, null, _provider, NullLogger<HealthEndpointCore>.Instance));
        var providerEx = Assert.Throws<ArgumentNullException>(() => new HealthEndpointCore(_options, _aggregator, contributors, ServiceOptions(), null, NullLogger<HealthEndpointCore>.Instance));
    ...
    public void InvokeWithInvalidGroupReturnsAllContributors()
    {
        ...
        var ep = new HealthEndpointCore(options, new HealthRegistrationsAggregator(), contributors, ServiceProviderWithMicrosoftHealth(), _provider, NullLogger<HealthEndpointCore>.Instance);
    ...
    public void InvokeWithReadinessGroupReturnsGroupResults2()
    {
        ...
        IOptionsMonitor<HealthEndpointOptions> options = GetOptionsMonitorFromSettings<HealthEndpointOptions, ConfigureHealthEndpointOptions>();
        var ep = new HealthEndpointCore(options, _aggregator, contributors, ServiceProviderWithMicrosoftHealth(), _provider, NullLogger<HealthEndpointCore>.Instance);
        var context = Substitute.For<ISecurityContext>();
