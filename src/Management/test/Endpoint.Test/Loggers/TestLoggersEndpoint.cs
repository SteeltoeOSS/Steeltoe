...
{
    public TestLoggersEndpoint(IOptionsMonitor<LoggersEndpointOptions> options, IDynamicLoggerProvider loggerProvider = null, ILogger<LoggersEndpoint> logger = null)
