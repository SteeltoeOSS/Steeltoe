...
{
    public TestLoggersEndpoint(IOptionsMonitor<LoggersEndpointOptions> options, ILoggerFactory loggerFactory, IDynamicLoggerProvider loggerProvider)
        : base(options, loggerFactory, loggerProvider)
    {
    }
