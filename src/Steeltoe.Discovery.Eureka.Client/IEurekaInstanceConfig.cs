...
namespace Steeltoe.Discovery.Eureka
{
    ...
    {
        /// <summary>
        /// The unique Id (within the scope of the appName) of this instance to be registered with eureka.
        /// Configuration property: eureka:instance:instanceId
        /// </summary>
        string InstanceId { get; set; }

        /// <summary>
        /// The name of the application to be registered with eureka.
        /// Configuration property: eureka:instance:name
        /// </summary>
        string AppName { get; set; }

        /// <summary>
        /// The name of the application group to be registered with eureka.
        ...
        /// <summary>
        /// The <code>Secure port</code> on which the instance should receive traffic.
        ...
        /// <summary>
        /// The virtual host name defined for this instance.
        ///
        ...
        /// <summary>
        /// The secure virtual host name defined for this instance.
        ///
        /// This is typically the way other instance would find this instance by using the virtual host name.
        /// Think of this as similar to the fully qualified domain name, that the users of your services will 
        /// need to find this instance.
        ...
        /// <summary>
        /// The <code>AWS autoscaling group name</code> associated with this instance. This information is 
        ...
        /// <summary>
        /// The metadata name/value pairs associated with this instance. This information is sent to eureka 
        ...
        /// <summary>
        /// The data center this instance is deployed. This information is used to get some AWS specific 
        /// instance information if the instance is deployed in AWS.
        /// </summary>
        IDataCenterInfo DataCenterInfo { get; set; }

        /// <summary>
        /// The IPAdress of the instance. This information is for academic purposes only as the communication 
        /// from other instances primarily happen using the information supplied in <see cref="GetHostName(bool)"/>
        /// </summary>
        string IpAddress { get; set; }

        /// <summary>
        /// The relative status page <em>Path</em> for this instance. The status page URL is then constructed out of the
        ...
        /// <summary>
        /// The absolute status page for this instance. The users can provide the StatusPageUrlPath if the status page
        ...
        /// <summary>
        /// Gets the relative home page URL <em>Path</em> for this instance.
        ...
        /// <summary>
        /// Gets the absolute home page URL for this instance. The users can provide the path if the home page resides in the
        ...
        /// <summary>
        /// Gets the relative health check URL <em>Path</em> for this instance. The health check page URL 
        ...
        /// <summary>
        /// Gets the absolute health check page URL for this instance. The users can provide the path if the health
        ...
        /// <summary>
        /// Gets the absolute secure health check page URL for this instance. The users can provide the path if the
        ...
        /// <summary>
        /// An instance's network addresses should be fully expressed in it's <see cref="DataCenterInfo"/>
