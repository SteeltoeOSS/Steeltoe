...
namespace Steeltoe.Common.Expression.Internal.Spring
{
    public class SpelDocumentationTests : AbstractExpressionTests
    {
        ...
        public class IEEE
        {
            ...
            public List<object> Members2 = new List<object>();
            public Dictionary<string, object> Officers = new Dictionary<string, object>();
            public List<Dictionary<string, object>> Reverse = new List<Dictionary<string, object>>();
