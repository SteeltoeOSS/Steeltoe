...
public static class ConfigurationExtensions
{
    ...
    /// </param>
    public static IConfigurationBuilder AddPemFiles(this IConfigurationBuilder builder, string certificateName, string certificateFilePath, string keyFilePath,
        bool optional = false)
    {
    ...
    /// </param>
    /// <remarks>
    /// In contrast with <see cref="AddPemFiles(IConfigurationBuilder, string, string, string, bool)" />, this extension adds the path of the file instead of
    /// the contents. Certificate parsing is handled by <see cref="ConfigureNamedCertificateOptions" />.
    /// </remarks>
    public static IConfigurationBuilder AddCertificateFile(this IConfigurationBuilder builder, string certificateName, string certificateFilePath,
        bool optional = false)
    {
        ArgumentGuard.NotNull(builder);
        ArgumentGuard.NotNullOrEmpty(certificateFilePath);
