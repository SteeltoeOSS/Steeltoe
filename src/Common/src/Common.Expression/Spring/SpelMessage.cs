...
#pragma warning disable IDE0090
    ...
    public static readonly SpelMessage NOT_A_REAL = new (
        Kind.ERROR, 1040, "The value ''{0}'' cannot be parsed as a double");

    public static readonly SpelMessage MORE_INPUT = new (
        Kind.ERROR, 1041, "After parsing a valid expression, there is still more data in the expression: ''{0}''");

    public static readonly SpelMessage RIGHT_OPERAND_PROBLEM = new (
        Kind.ERROR, 1042, "Problem parsing right operand");

    public static readonly SpelMessage NOT_EXPECTED_TOKEN = new (
    ...
    public static readonly SpelMessage NON_TERMINATING_DOUBLE_QUOTED_STRING = new (
        Kind.ERROR, 1045, "Cannot find terminating \" for string");

    public static readonly SpelMessage NON_TERMINATING_QUOTED_STRING = new (
        Kind.ERROR, 1046, "Cannot find terminating '' for string");

    public static readonly SpelMessage MISSING_LEADING_ZERO_FOR_NUMBER = new (
        Kind.ERROR, 1047, "A real number must be prefixed by zero, it cannot start with just ''.''");

    public static readonly SpelMessage REAL_CANNOT_BE_LONG = new (
        Kind.ERROR, 1048, "Real number cannot be suffixed with a long (L or l) suffix");

    public static readonly SpelMessage UNEXPECTED_DATA_AFTER_DOT = new (
        Kind.ERROR, 1049, "Unexpected data after ''.'': ''{0}''");

    public static readonly SpelMessage MISSING_CONSTRUCTOR_ARGS = new (
        Kind.ERROR, 1050, "The arguments '(...)' for the constructor call are missing");

    public static readonly SpelMessage RUN_OUT_OF_ARGUMENTS = new (
        Kind.ERROR, 1051, "Unexpectedly ran out of arguments");

    public static readonly SpelMessage UNABLE_TO_GROW_COLLECTION = new (
        Kind.ERROR, 1052, "Unable to grow collection");

    public static readonly SpelMessage UNABLE_TO_GROW_COLLECTION_UNKNOWN_ELEMENT_TYPE = new (
        Kind.ERROR, 1053, "Unable to grow collection: unable to determine list element type");

    public static readonly SpelMessage UNABLE_TO_CREATE_LIST_FOR_INDEXING = new (
        Kind.ERROR, 1054, "Unable to dynamically create a List to replace a null value");

    public static readonly SpelMessage UNABLE_TO_CREATE_MAP_FOR_INDEXING = new (
        Kind.ERROR, 1055, "Unable to dynamically create a Map to replace a null value");

    public static readonly SpelMessage UNABLE_TO_DYNAMICALLY_CREATE_OBJECT = new (
        Kind.ERROR, 1056, "Unable to dynamically create instance of ''{0}'' to replace a null value");

    public static readonly SpelMessage NO_SERVICE_RESOLVER_REGISTERED = new (
        Kind.ERROR, 1057, "No service resolver registered in the context to resolve access to service ''{0}''");

    public static readonly SpelMessage EXCEPTION_DURING_SERVICE_RESOLUTION = new (
        Kind.ERROR, 1058, "A problem occurred when trying to resolve service ''{0}'':''{1}''");

    public static readonly SpelMessage INVALID_SERVICE_REFERENCE = new (
        Kind.ERROR, 1059, "@ or & can only be followed by an identifier or a quoted name");

    public static readonly SpelMessage TYPE_NAME_EXPECTED_FOR_ARRAY_CONSTRUCTION = new (
        Kind.ERROR, 1060, "Expected the type of the new array to be specified as a String but found ''{0}''");

    public static readonly SpelMessage INCORRECT_ELEMENT_TYPE_FOR_ARRAY = new (
        Kind.ERROR, 1061, "The array of type ''{0}'' cannot have an element of type ''{1}'' inserted");

    public static readonly SpelMessage MULTIDIM_ARRAY_INITIALIZER_NOT_SUPPORTED = new (
        Kind.ERROR, 1062, "Using an initializer to build a multi-dimensional array is not currently supported");

    public static readonly SpelMessage MISSING_ARRAY_DIMENSION = new (
        Kind.ERROR, 1063, "A required array dimension has not been specified");

    public static readonly SpelMessage INITIALIZER_LENGTH_INCORRECT = new (
        Kind.ERROR, 1064, "Array initializer size does not match array dimensions");

    public static readonly SpelMessage UNEXPECTED_ESCAPE_CHAR = new (
        Kind.ERROR, 1065, "Unexpected escape character");

    public static readonly SpelMessage OPERAND_NOT_INCREMENTABLE = new (
        Kind.ERROR, 1066, "The expression component ''{0}'' does not support increment");

    public static readonly SpelMessage OPERAND_NOT_DECREMENTABLE = new (
        Kind.ERROR, 1067, "The expression component ''{0}'' does not support decrement");

    public static readonly SpelMessage NOT_ASSIGNABLE = new (
        Kind.ERROR, 1068, "The expression component ''{0}'' is not assignable");

    public static readonly SpelMessage MISSING_CHARACTER = new (
        Kind.ERROR, 1069, "Missing expected character ''{0}''");

    public static readonly SpelMessage LEFT_OPERAND_PROBLEM = new (
        Kind.ERROR, 1070, "Problem parsing left operand");

    public static readonly SpelMessage MISSING_SELECTION_EXPRESSION = new (
        Kind.ERROR, 1071, "A required selection expression has not been specified");

    public static readonly SpelMessage EXCEPTION_RUNNING_COMPILED_EXPRESSION = new (
        Kind.ERROR, 1072, "An exception occurred whilst evaluating a compiled expression");

    public static readonly SpelMessage FLAWED_PATTERN = new (
