...
public sealed class AesTextDecryptorTest
{
    ...
    public void CanDecryptSpringConfigCipher(string salt, string key, string cipher, string plainText)
    {
    ...
    public static TheoryData<string, string, string, string> GetTestVector()
    {
        ...
        TheoryData<string, string, string, string> theoryData = [];

        foreach ((string salt, string key, string cipher, string plainText) in data)
        {
            theoryData.Add(salt, key, cipher, plainText);
        }
