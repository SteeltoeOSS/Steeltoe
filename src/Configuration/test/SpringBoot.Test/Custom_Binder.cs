...
{
    public static void CustomBind(this IConfiguration configuration, object? instance)
    {
#if NET10_0_OR_GREATER
        CustomConfigurationBinder.Bind(configuration, instance, null);
#else
            ConfigurationBinder.Bind(configuration, instance, null);
#endif
    }
...
#if NET10_0_OR_GREATER
            CustomConfigurationBinder.Bind(section, opts, configureBinder);
#else
...
public static class CustomConfigurationBinder
{
    ...
    private static void BindProperties(object instance, IConfiguration configuration, BinderOptions options, ParameterInfo[]? constructorParameters)
    {
        ...
        if (options.ErrorOnUnknownConfiguration)
        {
            ...
            {
                throw new InvalidOperationException("SR.Error_MissingConfig");
            }
        }
        ...
        else
        {
            ...
            if (!string.IsNullOrEmpty(configValue))
            {
                ...
                if (options.ErrorOnUnknownConfiguration)
                {
                    ...
                    throw new InvalidOperationException("SR.Error_FailedBinding");
                }
            }
            else
            {
                ...
                if (bindingPoint.Value is null && configValue != null)
                // END: Patch to create instance from empty object
                {
        ...
        out ParameterInfo[]? constructorParameters)
    {
        ...
        {
            throw new InvalidOperationException("SR.Error_CannotActivateAbstractOrInterface");
        }
        ...
        {
            throw new InvalidOperationException("SR.Error_MissingPublicInstanceConstructor");
        }

        if (constructors.Length > 1 && !hasParameterlessConstructor)
        {
            throw new InvalidOperationException("SR.Error_MultipleParameterizedConstructors");
        }
        ...
        if (constructors.Length == 1 && !hasParameterlessConstructor)
        {
            ...
            {
                throw new InvalidOperationException("SR.Error_CannotBindToConstructorParameter");
            }
            ...
            {
                throw new InvalidOperationException("SR.Error_ConstructorParametersDoNotMatchProperties");
            }
        ...
        {
            throw new InvalidOperationException("SR.Error_FailedToActivate", ex);
        }

        return instance ?? throw new InvalidOperationException("SR.Error_FailedToActivate");
    }
        ...
        IConfiguration config, BinderOptions options)
    {
        ...
        foreach (IConfigurationSection child in config.GetChildren())
        {
            ...
            catch (Exception ex)
            {
                if (options.ErrorOnUnknownConfiguration)
                {
                    throw new InvalidOperationException("SR.Error_GeneralErrorWhenBinding", ex);
                }
            }
        }
    }
    ...
    private static Array BindArray(Type type, IEnumerable? source, IConfiguration config, BinderOptions options)
    {
        ...
        if (type.IsArray)
        {
            ...
            {
                throw new InvalidOperationException("SR.Error_UnsupportedMultidimensionalArray");
            }
        ...
        string? value, string? path, out object? result, out Exception? error)
    {
        ...
        if (converter.CanConvertFrom(typeof(string)))
        {
            ...
            {
                error = new InvalidOperationException("SR.Error_FailedBinding", ex);
            }
            return true;
        }
        ...
        BinderOptions options)
    {
        ...
        {
            throw new InvalidOperationException("SR.Error_ParameterBeingBoundToIsUnnamed");
        }
        ...
        if (propertyBindingPoint.Value is null)
        {
            ...
            {
                throw new InvalidOperationException("SR.Error_ParameterHasNoMatchingConfig");
            }
        }
...
internal sealed class BindingPoint
{
    ...
    public bool HasNewValue
    {
        get
        {
            ...
            return _initialValue?.GetType() is { } initialValueType && initialValueType.IsValueType
