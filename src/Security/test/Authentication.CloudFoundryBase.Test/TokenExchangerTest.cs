...
public class TokenExchangerTest
{
    ...
    public void GetTokenRequestMessage_ReturnsCorrectly()
    {
        ...
        HttpRequestMessage message = tEx.GetTokenRequestMessage(new List<KeyValuePair<string, string>>(), "redirectUri");
    ...
    public void AuthCodeTokenRequestParameters_ReturnsCorrectly()
    {
        ...
        List<KeyValuePair<string, string>> parameters = tEx.AuthCodeTokenRequestParameters("authcode");
    ...
    public void ClientCredentialsTokenRequestParameters_ReturnsCorrectly()
    {
        ...
        List<KeyValuePair<string, string>> parameters = tEx.ClientCredentialsTokenRequestParameters();
    ...
    public void CommonTokenRequestParamsHandlesScopes()
    {
        var opts = new AuthServerOptions
        {
            AdditionalTokenScopes = "onescope",
            RequiredScopes = new[]
            {
                "twoscope"
            }
        ...
        List<KeyValuePair<string, string>> parameters = tEx.CommonTokenRequestParams();
    ...
    private HttpClient GetMockHttpClient()
    {
        ...
        mockHttp.When("http://localhost/tokenUrl").WithFormData("code", "goodCode").Respond("application/json", RealTokenResponse); // Respond with JSON
        mockHttp.When("http://localhost/tokenUrl").WithFormData("code", "badCode").Respond(HttpStatusCode.BadRequest); // Respond with JSON
