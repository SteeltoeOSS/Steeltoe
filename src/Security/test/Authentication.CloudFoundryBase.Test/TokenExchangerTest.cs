...
public class TokenExchangerTest
{
    ...
    private HttpClient GetMockHttpClient()
    {
        ...
        mockHttp
            ...
            .Respond("application/json", _realTokenResponse); // Respond with JSON
        mockHttp
            .When("http://localhost/tokenUrl")
