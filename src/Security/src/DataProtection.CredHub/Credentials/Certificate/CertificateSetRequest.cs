...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CertificateSetRequest" /> class. For writing a certificate to CredHub.
    /// </summary>
    /// <param name="credentialName">
    /// Name of credential to set.
    /// </param>
    ...
    /// Certificate authority value of credential to set.
    /// </param>
    /// <param name="certificateAuthorityName">
    /// Name of CA credential in credhub that has signed this certificate.
    /// </param>
    /// <remarks>
    /// Must include either the CA or CA Name.
    /// </remarks>
    public CertificateSetRequest(string credentialName, string privateKey, string certificate, string certificateAuthority = null,
