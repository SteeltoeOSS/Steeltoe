...
public interface ICredHubClient
{
    ...
    /// The credential to write to CredHub; must not be <see langword="null" />.
    /// </param>
    /// <typeparam name="T">
    /// Type of CredHub credential to be written.
    /// </typeparam>
    /// <returns>
    ...
    /// Parameters for the new credential to be generated in CredHub.
    /// </param>
    /// <typeparam name="T">
    /// Type of CredHub credential to be generated.
    /// </typeparam>
    /// <returns>
    ...
    /// </param>
    /// <typeparam name="T">
    /// Type of CredHub credential to be regenerated.
    /// </typeparam>
    /// <returns>
    /// Regenerated credential details.
    /// </returns>
    ...
    /// Name of certificate authority used to generate certificates that should be regenerated.
    /// </param>
    /// <returns>
    /// List of regenerated certificates.
    /// </returns>
    ...
    /// </summary>
    /// <param name="id">
    /// ID of the credential; must not be <see langword="null" />.
    /// </param>
    /// <typeparam name="T">
    /// Type of CredHub credential to be retrieved.
    /// </typeparam>
    /// <returns>
    ...
    /// </summary>
    /// <param name="name">
    /// Name of the credential; must not be <see langword="null" />.
    /// </param>
    /// <typeparam name="T">
    /// Type of CredHub credential to be retrieved.
    /// </typeparam>
    ...
    /// </summary>
    /// <param name="name">
    /// The name of the credential; must not be <see langword="null" />.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="path">
    /// The path to the credential; must not be <see langword="null" />.
    /// </param>
    /// <returns>
    /// A summary of the credential search results.
    /// </returns>
    ...
    /// A collection of permissions to add.
    /// </param>
    /// <returns>
    /// List of permissions.
    /// </returns>
    ...
    /// </param>
    /// <param name="actor">
    /// the actor of the permission; must not be <see langword="null" />.
    /// </param>
    /// <returns>
    ...
    /// a data structure of bound service credentials, as would be parsed from the {@literal VCAP_SERVICES} environment variable provided to applications
