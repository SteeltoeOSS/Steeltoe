...
namespace SteelToe.Discovery.Eureka
{
    public interface IEurekaClientConfig
    {
        ...
        /// <summary>
        /// The proxy host to the eureka server if any.
        ...
        /// <summary>
        /// Indicates whether to get the <em>applications</em> after filtering the applications for instances with only UP states.
        /// The changes are effective at runtime at the next registry fetch cycle as specified by <see cref="RegistryFetchIntervalSeconds"/>
        ///
        ...
        /// <summary>
        /// If set to true, local status updates via ApplicationInfoManager#setInstanceStatus(InstanceStatus)}
