...
{
    /// <summary>
    /// Configuration source used in creating a <see cref="RandomNumberProvider"/> that generates random numbers
    /// </summary>
    public class RandomNumberSource : IConfigurationSource
    {
        ...
        public RandomNumberSource(ILoggerFactory logFactory = null)
        ...
        /// <param name="logFactory">the logger factory to use</param>
        public RandomNumberSource(string prefix, ILoggerFactory logFactory = null)
        {
        ...
        /// <summary>
        /// Builds a <see cref="RandomNumberProvider"/> from the sources.
        /// </summary>
        /// <param name="builder">the provided builder</param>
        /// <returns>the random number provider</returns>
        public IConfigurationProvider Build(IConfigurationBuilder builder)
        {
            return new RandomNumberProvider(_prefix, _loggerFactory);
        }
    }
}
