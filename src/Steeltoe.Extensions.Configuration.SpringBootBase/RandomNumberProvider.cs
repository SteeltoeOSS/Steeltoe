...
{
    /// <summary>
    /// Configuration provider that provides random numbers
    /// </summary>
    public class RandomNumberProvider : ConfigurationProvider
    {
        internal ILogger<RandomNumberProvider> _logger;
        ...
        public RandomNumberProvider(string prefix, ILoggerFactory logFactory = null)
        {
            _prefix = prefix ?? throw new ArgumentNullException(nameof(prefix));
            _logger = logFactory?.CreateLogger<RandomNumberProvider>();
            _random = new System.Random();
        }

        /// <summary>
        /// Will generate a random value depending on the key thats provided
        /// </summary>
        ...
        /// <summary>
        /// Simply creates a new underlying Random number generator.
        /// </summary>
