...
{
    public static string[] MicrosoftAssemblies { get; internal set; } =
    {
    ...
    public static string[] MicrosoftInterfaceTypeNames { get; internal set; } =
    {
        "Microsoft.Extensions.Caching.Distributed.IDistributedCache"
    };

    public static string[] MicrosoftImplementationTypeNames { get; internal set; } =
    {
        "Microsoft.Extensions.Caching.Redis.RedisCache",
        "Microsoft.Extensions.Caching.StackExchangeRedis.RedisCache"
    };

    public static string[] MicrosoftOptionNames { get; internal set; } =
    {
        "Microsoft.Extensions.Caching.Redis.RedisCacheOptions",
        "Microsoft.Extensions.Caching.StackExchangeRedis.RedisCacheOptions"
    };

    public static string[] StackExchangeAssemblies { get; internal set; } =
    {
        "StackExchange.Redis",
        "StackExchange.Redis.StrongName"
    };

    public static string[] StackExchangeInterfaceTypeNames { get; internal set; } =
    {
        "StackExchange.Redis.IConnectionMultiplexer"
    };

    public static string[] StackExchangeImplementationTypeNames { get; internal set; } =
    {
        "StackExchange.Redis.ConnectionMultiplexer"
    };

    public static string[] StackExchangeOptionNames { get; internal set; } =
    {
    ...
    /// </summary>
    public static Type MicrosoftInterface =>
        ReflectionHelpers.FindTypeOrThrow(MicrosoftAssemblies, MicrosoftInterfaceTypeNames, MicrosoftInterfaceTypeNames[0],
            "a Microsoft Caching NuGet Reference");

    /// <summary>
    /// Gets RedisCache from a Microsoft Cache library.
    /// </summary>
    public static Type MicrosoftImplementation =>
        ReflectionHelpers.FindTypeOrThrow(MicrosoftAssemblies, MicrosoftImplementationTypeNames, "RedisCache", "a Microsoft Caching NuGet Reference");

    /// <summary>
    /// Gets RedisCacheOptions from a Microsoft Cache library.
    /// </summary>
    public static Type MicrosoftOptions =>
        ReflectionHelpers.FindTypeOrThrow(MicrosoftAssemblies, MicrosoftOptionNames, MicrosoftOptionNames[0], "a Microsoft Caching NuGet Reference");

    /// <summary>
    /// Gets IConnectionMultiplexer from a StackExchange Redis library.
    /// </summary>
    public static Type StackExchangeInterface =>
        ReflectionHelpers.FindTypeOrThrow(StackExchangeAssemblies, StackExchangeInterfaceTypeNames, StackExchangeInterfaceTypeNames[0],
    ...
    /// </summary>
    public static Type StackExchangeOptions =>
        ReflectionHelpers.FindTypeOrThrow(StackExchangeAssemblies, StackExchangeOptionNames, StackExchangeOptionNames[0],
            "a Stack Exchange Redis NuGet Reference");
    ...
    public static MethodInfo StackExchangeInitializer =>
        FindMethodOrThrow(StackExchangeImplementation, "Connect", new[]
        {
