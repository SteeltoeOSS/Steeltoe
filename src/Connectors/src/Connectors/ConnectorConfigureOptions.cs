...
public sealed class ConnectorConfigureOptions
{
    /// <summary>
    ...
    /// duplicate expensive calls. Be aware that detecting configuration changes only makes sense when <see cref="ConnectorAddOptions.CacheConnection" /> is
    /// <c>false</c>.
    /// </summary>
