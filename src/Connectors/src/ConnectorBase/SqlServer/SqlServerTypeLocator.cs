...
public static class SqlServerTypeLocator
{
    ...
    /// </summary>
    public static string[] Assemblies { get; internal set; } = new string[] { "Microsoft.Data.SqlClient", "System.Data.SqlClient" };

    /// <summary>
    /// Gets the list of SQL Server types that implement IDbConnection
    /// </summary>
    public static string[] ConnectionTypeNames { get; internal set; } = new string[] { "Microsoft.Data.SqlClient.SqlConnection", "System.Data.SqlClient.SqlConnection" };
}