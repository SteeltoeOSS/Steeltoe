...
internal static class MySqlDbContextOptionsExtensionsShim
{
    ...
    private static void UseOracleMySql(MySqlEntityFrameworkCorePackageResolver packageResolver, DbContextOptionsBuilder optionsBuilder, string connectionString,
        object? mySqlOptionsAction)
    {
    ...
    private static void UsePomeloMySql(MySqlEntityFrameworkCorePackageResolver packageResolver, DbContextOptionsBuilder optionsBuilder, string connectionString,
        object? serverVersion, object? mySqlOptionsAction)
    {
