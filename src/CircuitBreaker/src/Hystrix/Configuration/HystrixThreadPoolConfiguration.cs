...
public class HystrixThreadPoolConfiguration
{
    ...
    public HystrixThreadPoolConfiguration(IHystrixThreadPoolKey threadPoolKey, int coreSize, int maximumSize, int maxQueueSize, int queueRejectionThreshold,
        int keepAliveTimeInMinutes, bool allowMaximumSizeToDivergeFromCoreSize, int rollingCounterNumberOfBuckets, int rollingCounterBucketSizeInMilliseconds)
    {
    ...
    {
        return new HystrixThreadPoolConfiguration(threadPoolKey, threadPoolProperties.CoreSize, threadPoolProperties.MaximumSize,
            threadPoolProperties.MaxQueueSize, threadPoolProperties.QueueSizeRejectionThreshold, threadPoolProperties.KeepAliveTimeMinutes,
            threadPoolProperties.AllowMaximumSizeToDivergeFromCoreSize, threadPoolProperties.MetricsRollingStatisticalWindowBuckets,
