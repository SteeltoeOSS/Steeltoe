...
namespace Steeltoe.CircuitBreaker.Hystrix.Metric
{
    public class HystrixCommandCompletion : HystrixCommandEvent
    {
        ...
        private readonly static IList<HystrixEventType> ALL_EVENT_TYPES = HystrixEventTypeHelper.Values;

        HystrixCommandCompletion(ExecutionResult executionResult, IHystrixCommandKey commandKey,
                                 IHystrixThreadPoolKey threadPoolKey, HystrixRequestContext requestContext) : base(commandKey, threadPoolKey)
        {
