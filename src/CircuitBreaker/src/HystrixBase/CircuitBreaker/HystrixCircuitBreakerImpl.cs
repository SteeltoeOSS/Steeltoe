...
namespace Steeltoe.CircuitBreaker.Hystrix.CircuitBreaker
{
    internal class HystrixCircuitBreakerImpl : ICircuitBreaker
    {
        ...
        private readonly AtomicBoolean circuitOpen = new AtomicBoolean(false);

        /* when the circuit was marked open or was last allowed to try a 'singleTest' */
        private readonly AtomicLong circuitOpenedOrLastTestedTime = new AtomicLong();
        ...
        {
            var timeCircuitOpenedOrWasLastTested = circuitOpenedOrLastTestedTime.Value;
...
#pragma warning restore S1066 // Collapsible "if" statements should be merged
        ...
        public bool IsOpen
        {
            get
            {
                ...
                var health = metrics.Healthcounts;
