...
public class HystrixThreadPoolOptionsTest
{
    ...
    public static HystrixThreadPoolOptions GetUnitTestPropertiesBuilder()
    {
        return new HystrixThreadPoolOptions
        {
            ...
            MaxQueueSize =
                100, // size of queue (but we never allow it to grow this big ... this can't be dynamically changed so we use 'queueSizeRejectionThreshold' to artificially limit and reject)
