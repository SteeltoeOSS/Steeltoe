    ...
    public class HystrixConfigurationStreamTest : CommandStreamTest
    {
        ...
        public void TestStreamHasData()
        {
            ...
            stream.Observe().Take(num).Subscribe(
                (configuration) =>
                {
                    output.WriteLine((DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond) + " : " + Thread.CurrentThread.ManagedThreadId + " : Received data with : " + configuration.CommandConfig.Count + " commands");
        ...
        public void TestTwoSubscribersOneUnsubscribes()
        {
            ...
            IDisposable s1 = stream
                    ...
                    (configuration) =>
                    {
                        output.WriteLine((DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond) + " : " + Thread.CurrentThread.ManagedThreadId + " : Dashboard 1 OnNext : " + configuration.CommandConfig.Count + " commands");
            ...
            IDisposable s2 = stream
                ...
                (configuration) =>
                {
                    output.WriteLine((DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond) + " : " + Thread.CurrentThread.ManagedThreadId + " : Dashboard 2 OnNext : " + configuration.CommandConfig.Count + " commands");
