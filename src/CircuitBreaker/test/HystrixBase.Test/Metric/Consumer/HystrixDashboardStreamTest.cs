    ...
    public class HystrixDashboardStreamTest : CommandStreamTest, IDisposable
    {
        ...
        public void TestStreamHasData()
        {
            ...
            stream.Observe().Take(num).Subscribe(
                (dashboardData) =>
                {
                    output.WriteLine((DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond) + " : Received data with : " + dashboardData.CommandMetrics.Count + " commands");
        ...
        public void TestTwoSubscribersOneUnsubscribes()
        {
            ...
            IDisposable s1 = stream
                    ...
                    .Subscribe(
                        (dashboardData) =>
                        {
                            output.WriteLine((DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond) + " : " + Thread.CurrentThread.ManagedThreadId + " : Dashboard 1 OnNext : " + dashboardData);
            ...
            IDisposable s2 = stream
                ...
                .Subscribe(
                    (dashboardData) =>
                    {
                        output.WriteLine((DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond) + " : " + Thread.CurrentThread.ManagedThreadId + " : Dashboard 2 OnNext : " + dashboardData);
