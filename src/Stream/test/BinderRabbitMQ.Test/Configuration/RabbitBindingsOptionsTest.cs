...
public class RabbitBindingsOptionsTest
{
    ...
    public void InitializeAll_FromDefaultValues()
    {
        ...
        IConfigurationSection configuration = builder.Build().GetSection("spring:cloud:stream:rabbit");
        var options = new RabbitBindingsOptions(configuration);
        options.PostProcess();
    ...
    public void InitializeAll_FromConfigValues()
    {
        ...
        IConfigurationSection configuration = builder.Build().GetSection(RabbitBindingsOptions.Prefix);
        var options = new RabbitBindingsOptions(configuration);
        options.PostProcess();
        Assert.NotNull(options.Default);
        Assert.NotNull(options.Default.Consumer);
    ...
    private IEnumerable<Tuple<string, string, string>> GetOptionsConfigPairs(IConfigurationSection section, object optionsObject, string inputBindingsKey)
    {
        IConfigurationSection inputBindingSection = section.GetSection(inputBindingsKey);
