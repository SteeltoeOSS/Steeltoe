...
namespace Steeltoe.Stream.Binder.RabbitMQ.Configuration;
...
public class RabbitCommonOptions
{
    ...
    {
        ExchangeType ??= defaultOptions != null ? defaultOptions.ExchangeType : Steeltoe.Messaging.RabbitMQ.Configuration.ExchangeType.Topic;
        ...
        DeadLetterExchangeType ??=
            defaultOptions != null ? defaultOptions.DeadLetterExchangeType : Steeltoe.Messaging.RabbitMQ.Configuration.ExchangeType.Direct;
