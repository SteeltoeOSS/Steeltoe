...
/// <summary>
/// A strategy interface used to bind an app interface to a logical name. The name is intended to identify a logical consumer or producer of messages.
/// This may be a queue, a channel adapter, another message channel, etc.
/// </summary>
public interface IBinder : IServiceNameAware, IDisposable
{
    ...
    /// </param>
    /// <param name="outboundTarget">
    /// the application interface to be bound as a producer.
    /// </param>
    /// <param name="producerOptions">
...
/// <summary>
/// A typed version of the strategy interface used to bind an app interface to a logical name. The name is intended to identify a logical consumer or
/// producer of messages. This may be a queue, a channel adapter, another message channel, etc.
/// </summary>
/// <typeparam name="T">
