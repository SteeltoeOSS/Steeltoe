...
/// <summary>
/// Represents a binding between an input or output and an adapter endpointHandler that connects via a Binder.The binding could be for a consumer or a producer.
