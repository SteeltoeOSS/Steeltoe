...
public static class StreamListenerErrorMessages
{
    ...
    public const string InvalidInputOutputMethodParameters = "Input or Output attribute "
                                                                 + "are not permitted on "
                                                                 + "method parameters while using the StreamListener value and a method-level output specification";

    public const string NoInputDestination = "No input destination is configured. "
                                               + "Use either the StreamListener value or Input";

    public const string AmbiguousMessageHandlerMethodArguments = "Ambiguous method arguments "
                                                                     + "for the StreamListener method";

    public const string InvalidInputValues = "Cannot set both StreamListener "
                                               + "value and Input attribute as method parameter";

    public const string InvalidInputValueWithOutputMethodParam = "Setting the StreamListener "
    ...
    public const string InvalidOutputValues = "Cannot set both output (Output/SendTo) method attribute value"
                                                + " and Output attribute as a method parameter";

    public const string ConditionOnDeclarativeMethod = "Cannot set a condition when "
                                                          + "using StreamListener in declarative mode";

    public const string ConditionOnMethodReturningValue = "Cannot set a condition "
                                                              + "for methods that return a value";

    public const string MultipleValueReturningMethods = "If multiple StreamListener "
    ...
    public const string ReturnTypeNoOutboundSpecified =
        $"{Prefix}having a return type should also have an outbound target specified";

    public const string ReturnTypeMultipleOutboundSpecified =
