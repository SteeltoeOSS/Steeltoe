...
namespace Steeltoe.Messaging.Rabbit.Listener.Adapters
{
    public class MessagingMessageListenerAdapterTest : AbstractTest
    {
        ...
        protected MessagingMessageListenerAdapter CreateMultiInstance(MethodInfo m1, MethodInfo m2, bool returnExceptions)
        {
            ...
            methods.Add(factory.CreateInvocableHandlerMethod(sample, m1));
            methods.Add(factory.CreateInvocableHandlerMethod(sample, m2));
        ...
        protected MessagingMessageListenerAdapter CreateInstance(MethodInfo m, bool returnExceptions)
        {
            ...
            adapter.HandlerAdapter = new HandlerAdapter(factory.CreateInvocableHandlerMethod(sample, m));
            return adapter;
        }
        ...
        {
            BatchMessagingMessageListenerAdapter adapter = new BatchMessagingMessageListenerAdapter(null, null, m, false, null, null);
            adapter.HandlerAdapter = new HandlerAdapter(factory.CreateInvocableHandlerMethod(sample, m));
            return adapter;
        }
        ...
        private class SampleBean
        {
            ...
            {
                this.BatchPayloads = new List<object>();
