...
{
    public class GenericMessagingTemplate : AbstractDestinationResolvingMessagingTemplate<IMessageChannel>
    {
        ...
        public GenericMessagingTemplate(ILogger logger = null)
            : base(null)
        {
            _logger = logger;
        }

        public GenericMessagingTemplate(IServiceProvider serviceProvider, ILogger logger = null)
        ...
        protected IMessage DoReceive(IMessageChannel channel, int timeout)
        {
            ...
            if (message == null)
            {
                _logger?.LogTrace("Failed to receive message from channel '" + channel);
            }
        ...
        private class TemporaryReplyChannel : IPollableChannel
        {
            ...
            public string Name => "TempReplyChannel";
