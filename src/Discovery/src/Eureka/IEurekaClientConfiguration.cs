...
public interface IEurekaClientConfiguration
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether indicates whether or not this instance should register its information with eureka server for discovery by
    /// others. In some cases, you do not want your instances to be discovered whereas you just want do discover other instances. Configuration property:
