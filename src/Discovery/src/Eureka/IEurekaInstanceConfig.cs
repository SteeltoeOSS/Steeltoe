...
public interface IEurekaInstanceConfig
{
    ...
    /// non-secure
    /// </c>
    /// port on which the instance should receive traffic. Configuration property: eureka:instance:port.
    /// </summary>
    ...
    /// Secure port
    /// </c>
    /// on which the instance should receive traffic. Configuration property: eureka:instance:securePort.
    /// </summary>
    ...
    /// non-secure
    /// </c>
    /// port should be enabled for traffic or not. Set true if the
    /// <c>
    /// non-secure
    /// </c>
    /// port is enabled, false otherwise. Configuration property: eureka:instance:nonSecurePortEnabled.
    /// </summary>
    ...
    /// </c>
    /// associated with this instance. This information is specifically used in an AWS environment to automatically put an instance out of service after the
    /// instance is launched and it has been disabled for traffic.. Configuration property: eureka:instance:asgName.
    /// </summary>
