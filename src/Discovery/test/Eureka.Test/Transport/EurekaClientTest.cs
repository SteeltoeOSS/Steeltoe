...
public sealed class EurekaClientTest
{
    ...
    public async Task GetApplicationsAsync_SendsRequestToServer()
    {
        ...
        Applications applications = await client.GetApplicationsAsync(CancellationToken.None);
    ...
    public async Task GetDeltaAsync_SendsRequestToServer()
    {
        ...
        Applications applications = await client.GetDeltaAsync(CancellationToken.None);
    ...
    public async Task GetVipAsync_SendsRequestToServer()
    {
        ...
        Applications applications = await client.GetVipAsync("foo", CancellationToken.None);
